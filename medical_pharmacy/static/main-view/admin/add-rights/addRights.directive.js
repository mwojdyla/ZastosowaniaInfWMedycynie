    ...
    angular.module('app')
        .directive('addRights', function () {
            return {
                ...
                controller: ['$scope', '$filter', 'dataService', 'commonInformationsService', Controller]
            };

            function Controller($scope, $filter, dataService, commonInformationsService) {
                $scope.currentUser = commonInformationsService.getUser();
